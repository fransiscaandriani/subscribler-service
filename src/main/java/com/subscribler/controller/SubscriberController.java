...
public class SubscriberController {
    ...
    public List<Subscriber> getSubscribers(){ return subscriberRepository.findAll();}
    ...
    @DeleteMapping(value = "/subscribers/{subscriberId}", produces = "application/json; charset=utf-8")
